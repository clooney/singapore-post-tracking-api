Singapore Post Tracking API - Java
================================
Use Java to track Singapore Post shipments with Singapore Post Tracking API.

Features
--------
- Real-time Singapore Post tracking.
- Batch Singapore Post tracking.
- Other features to manage your Singapore Post tracking.
...
Then, start to track your Singapore Post shipments.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.singaporepost;
    ...
    public class CreateSingaporePostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setCourierCode("singapore-post");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateSingaporePostTrackingsExample {
...
Get status of the shipment:
    ...
    public class GetSingaporePostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                trackingParams.setCourierCode("singapore-post");
...
Update a tracking by ID:
    ...
    public class UpdateSingaporePostTrackingExample {
